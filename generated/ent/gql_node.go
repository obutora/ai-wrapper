...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case dot.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, dotImplementors...); err != nil {
				return nil, err
			}
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	case dot.Table:
		query := c.Dot.Query().
			Where(dot.IDIn(ids...))
		query, err := query.CollectFields(ctx, dotImplementors...)
		if err != nil {
			return nil, err
		}
